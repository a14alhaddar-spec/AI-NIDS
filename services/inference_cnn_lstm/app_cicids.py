"""
CNN-LSTM Inference Service for CICIDS2017
Loads the full CICIDS CNN-LSTM model
"""
...
try:
    model = tf.keras.models.load_model(os.path.join(MODEL_DIR, "cnn_lstm_model.h5"))
...
def infer():
    ...
    try:
        ...
        # Prepare for CNN-LSTM (needs shape: samples, timesteps, features)
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("CNN-LSTM Inference Service - CICIDS Full")
    print("="*60)
