...
Provides real-time threat detection using trained LSTM model
"""
...
ENCODER_PATH = 'models/lstm_encoder.joblib'
...
def predict(flow_data):
    """Make prediction using LSTM model or heuristic"""
