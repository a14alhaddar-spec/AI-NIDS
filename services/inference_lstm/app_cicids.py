"""
LSTM Inference Service for CICIDS2017
Loads the full CICIDS LSTM model
"""
...
def infer():
    ...
    try:
        ...
        # Prepare for LSTM (needs shape: samples, timesteps, features)
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("LSTM Inference Service - CICIDS Full")
    print("="*60)
